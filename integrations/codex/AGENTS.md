...
POST /api/v1/screener/run  { "manualFilters": [{"dimension":"RSI (14)","value":"Oversold (< 30)"}], "market": "futures" }
POST /api/v1/screener/run  { "manualFilters": [{"dimension":"Long / Short ratio","value":"Long-heavy"},{"dimension":"Funding rate","value":"Positive"}], "market": "futures" }
...
on ZebPay futures OHLCV where covered (the liquid priority set) and Binance-derived data otherwise;
funding-rate, long/short-ratio, and basis run live from OKX. Candles are
